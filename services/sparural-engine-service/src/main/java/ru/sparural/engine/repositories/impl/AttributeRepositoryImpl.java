...
public class AttributeRepositoryImpl implements AttributeRepository {
    ...
    public void deleteAllForMerchant(Long merchantId) {
        dslContext.delete(MerchantAttributeMerchant.MERCHANT_ATTRIBUTE_MERCHANT)
                .where(MerchantAttributeMerchant.MERCHANT_ATTRIBUTE_MERCHANT.MERCHANTSID.eq(merchantId))
                .execute();
    }
    ...
    public void saveMerchantAttributesOfMerchant(Long attributeId, Long merchantId) {
        dslContext.insertInto(MerchantAttributeMerchant.MERCHANT_ATTRIBUTE_MERCHANT)
                .set(MerchantAttributeMerchant.MERCHANT_ATTRIBUTE_MERCHANT.ATTRIBUTEID, attributeId)
                .set(MerchantAttributeMerchant.MERCHANT_ATTRIBUTE_MERCHANT.MERCHANTSID, merchantId)
                .set(MerchantAttributeMerchant.MERCHANT_ATTRIBUTE_MERCHANT.CREATEDAT, TimeHelper.currentTime())
                .set(MerchantAttributeMerchant.MERCHANT_ATTRIBUTE_MERCHANT.UPDATEDAT, TimeHelper.currentTime())
                .execute();
    }
