...
public class UserRequestsSubjectsRepositoryImpl implements UserRequestsSubjectsRepository {
    ...
    public List<UserRequestsSubject> getList(int offset, int limit) {
        return dslContext
                ...
                .orderBy(UserRequestsSubjects.USER_REQUESTS_SUBJECTS.CREATEDAT.desc())
                .offset(offset)
                .limit(limit)
                .fetch()
    ...
    public Optional<UserRequestsSubject> create(UserRequestsSubject date) {
        return dslContext
                ...
                .set(UserRequestsSubjects.USER_REQUESTS_SUBJECTS.CREATEDAT, TimeHelper.currentTime())
                .set(UserRequestsSubjects.USER_REQUESTS_SUBJECTS.UPDATEDAT, TimeHelper.currentTime())
                .returning()
