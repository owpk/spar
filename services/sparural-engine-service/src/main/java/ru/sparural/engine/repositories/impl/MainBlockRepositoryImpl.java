...
public class MainBlockRepositoryImpl implements MainBlockRepository {
    ...
    public Optional<MainBlock> updateByCode(String code, MainBlock mainBlock) {
        return dslContext.update(MainBlocks.MAIN_BLOCKS)
                ...
                .set(MainBlocks.MAIN_BLOCKS.SHOWCOUNTER, mainBlock.isShowCounter())
                .set(MainBlocks.MAIN_BLOCKS.SHOWENDDATE, mainBlock.isShowEndDate())
                .set(MainBlocks.MAIN_BLOCKS.SHOWPERCENTS, mainBlock.isShowPercents())
                .set(MainBlocks.MAIN_BLOCKS.SHOWBILLET, mainBlock.isShowBillet())
                .set(MainBlocks.MAIN_BLOCKS.UPDATEDAT, TimeHelper.currentTime())
