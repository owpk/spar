...
public class RetryingLoymaxServiceWrapper implements LoymaxService {
    ...
    @Override
    public LoymaxUser createLoymaxUser(Long userId, LoymaxUserInfo loymaxPersonUid, TokenExchangeResponse response) {
    ...
    public LoymaxUser createLoymaxUser(Long userId, LoymaxUserInfo loymaxUserInfo) {
        return loymaxService.createLoymaxUser(userId, loymaxUserInfo);
    }

    @Override
    public void beginLoymaxRegistration(String phoneNumber, Long userId) {
        loymaxService.beginLoymaxRegistration(phoneNumber, userId);
    }
    ...
    public List<LoymaxUserAttributeDto<String>> importUserAttribute(String token, Long loymaxUserId, String attributeName) {
        return loymaxService.importUserAttribute(token, loymaxUserId, attributeName);
    }
    ...
    public List<LoymaxUserInfoSystem> getUserInfoSystem(String phoneNumber) {
        return loymaxService.getUserInfoSystem(phoneNumber);
    }

    @Override
    public List<LoymaxUserQuestionDto> getUserQuestionsSystem(Long id) {
        return loymaxService.getUserQuestionsSystem(id);
    }

    @Override
    public LoymaxUserInfoSystem getUserInfoSystemByLoymaxUserId(String loymaxUserId) {
        return loymaxService.getUserInfoSystemByLoymaxUserId(loymaxUserId);
    }
    ...
    public CardQr getQrCode(LoymaxUser loymaxUser, Long cardId) {
        return (CardQr) retryIfTokenExpired(loymaxUser,
    ...
    public LoymaxPersonalGoodsResponseDto getPersonalGoods(LoymaxUser loymaxUser, String logicalName) {
        return (LoymaxPersonalGoodsResponseDto) retryIfTokenExpired(loymaxUser,
    ...
    @Override
    @SuppressWarnings("unchecked")
    public List<LoymaxCheckItem> getChecksList(LoymaxUser loymaxUser, Long cardId, Integer offset, Integer limit, Long dateStart, Long dateEnd) {
        return (List<LoymaxCheckItem>) retryIfTokenExpired(loymaxUser,
                () -> loymaxService.getChecksList(loymaxUser, cardId,
    ...
    public TokenExchangeResponse exchangeForTokenAdmin() {
        return loymaxService.exchangeForTokenAdmin();
    }
