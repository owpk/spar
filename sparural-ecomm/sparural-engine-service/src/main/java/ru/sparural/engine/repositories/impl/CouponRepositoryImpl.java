...
import ru.sparural.engine.entity.enums.CouponStates;
...
public class CouponRepositoryImpl implements CouponRepository {
    ...
    public Optional<Coupon> save(Coupon coupon) {
        return dslContext
                ...
                .set(table.QR_CONTENT, coupon.getQrContent())
                .set(table.COUPON_EMMISSIONS_ID, coupon.getCouponEmmissionsId())
                .set(table.COUPON_STATE, coupon.getCouponState() != null ?
                        CouponStates.valueOf(coupon.getCouponState()).getVal() :
                        CouponStates.Issued.getVal())
