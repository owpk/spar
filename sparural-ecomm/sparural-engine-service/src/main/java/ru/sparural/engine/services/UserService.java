...
public interface UserService {
    ...
    User createFromLoymaxDataAndSetClient(LoymaxUserInfo loymaxUserInfo, String phoneNumber,
                                          String hashedPassword);

    User createFromLoymaxDataWithRoleNames(LoymaxUserInfo loymaxUserInfo, String phoneNumber,
    ...
    List<UserIdLoymaxIdEntry> findUserIdsByLoymaxUserIds(List<Long> loymaxUserIds);
