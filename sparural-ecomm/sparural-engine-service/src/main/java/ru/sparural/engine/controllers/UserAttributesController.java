...
public class UserAttributesController {
    ...
    @KafkaSparuralMapping("user-attributes/import")
    public void importUserAttribute(@Payload LoymaxUsersDto wrapper) {
        userAttributesService.importUserAttribute(wrapper.getLoymaxUsersIds());
    }
}
