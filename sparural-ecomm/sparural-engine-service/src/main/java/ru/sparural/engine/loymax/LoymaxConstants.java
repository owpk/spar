...
public final class LoymaxConstants {
    ...
    private String userQuestionsSystem;
    ...
    private void init() {
        ...
        userQuestionsSystem = appendToPublicApiUrl("/v1.2/Users/{personId}/Questions");
        ...
        getAttributeValue = appendToSystemApiUrl("/v1.2/users/{userId}/AttributesValues");
