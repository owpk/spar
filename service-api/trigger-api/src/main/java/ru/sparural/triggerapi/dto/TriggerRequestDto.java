...
public class TriggerRequestDto implements Serializable {
    Long triggersTypeId;
    Long dateStart;
    Long dateEnd;
    ...
    @NotNull(message = "Please specify time unit")
    @Pattern(regexp = "[smhdwMy]",
            message = "Wrong time format, should match 's | m | h | d | w | M | y'")
    String timeUnit;
}
