...
const PushTab: FC = () => {
    ...
    const notificationsOptions: SelectOption[] = useMemo((): SelectOption[] => {
        return notificationsTypes.map((i) => ({
            value: i.id,
            label: i.name,
        }))
    }, [notificationsTypes])
        ...
        <>
            ...
            <Row gutter={[16, 16]}>
                <Col>
                    ...
                    <InputHolder>
                        <>
                            <Label>{t('forms.time_interval_during_day')}</Label>
                            <Row gutter={[8, 8]}>
                                <Col span={12}>
                                    <TimePickerComponent
                ...
                <Col>
                    ...
                    <InputHolder>
                        <Row>
                            <Col span={24}>
                                <Selector
                                    label={t('forms.notificationType')}
                                    placeholder={t('forms.notificationType')}
                ...
                <Col span={14}>
                    <Row align={'bottom'}>
                        ...
                        {/* <Col span={5}>
                            <div style={{ marginBottom: 16 }}>
                                <PhotoLoader
                                    size={138}
                                    label={t('forms.upload_something')}
                                    image={notification.photoUrl}
                                    onChange={(file) => setNotification(prev => ({ ...prev, file }))}
                                    onDelete={() => setNotification(prev => ({ ...prev, file: undefined }))}
                                />
                            </div>
                        </Col> */}
                    </Row>
                    <InputHolder>
                        <Row>
                            <Col span={24}>
                                <Selector
                                    label={t('forms.where_push_lead')}
                                    placeholder={t('forms.where_push_lead')}
                                    options={pushActionsOptions}
                                    onChange={(pushTarget) =>
                                        setNotification((prev) => ({
                                            ...prev,
                                            pushTarget,
