        ...
        <div className="">
            ...
            <Row align={'bottom'} gutter={[16, 16]}>
                ...
                <Col>
                    <InputHolder>
                        <TextField
                            error={validateError.subject}
                            label={t('forms.mail_subject')}
                            onChange={(subject) => {
                                setNotification((prev) => ({
                                    ...prev,
                                    subject,
            ...
            {/* period interval receiver group HTML */}
            <Row gutter={[16, 16]}>
                {/* REAPEAT PERIOD,TIME INTERVAL,RECIEVER USER ,GROUP USERS  */}
                <Col>
                    {/* REAPEAT PERIOD */}
                    <InputHolder>
                        <>
                    ...
                    {notification.trigger?.value === 'lifespan-of-currency' && (
                        <>
                            ...
                            <InputHolder>
                                <TextField
                                    label={t('forms.currency_days_before_during')}
                                    onChange={(currencyDaysBeforeBurning) => {
                                        setNotification((prev) => ({
                                            ...prev,
                ...
                {/* TEXT EDITOR */}
                <Col span={12}>
                    <Label>{t('forms.mail')}</Label>
                    <div className={styles.textEditorHolder}>
                        <TextEditor
                            error={validateError.messageHTML}
                            value={notification?.messageHTML || ''}
